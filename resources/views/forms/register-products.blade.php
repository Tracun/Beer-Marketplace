@extends("templates.template") @section('title', "Cadastro de Produtos") @section('content')
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-10">
            ...
            <input type="text" class="form-control" id="ingredients" name="ingredients" maxlength="99" required>
          </div>
          <div class="col-md-2">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-12">
            ...
            <textarea type="text" class="form-control" id="introduction" name="introduction" maxlength="80" rows="2"></textarea>
          </div>
        </div>
      </div>
      <div class="form-group">
